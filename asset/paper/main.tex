...
\begin{ack}
This project was self-funded. The total project cost, including rented GPU compute and hosted API usage for preference validation, repair verification, training, and evaluation, exceeded USD 150.
\end{ack}
